...
1. What is the procedure for logging into Hoffman2?  --> Type ssh @username@hoffman2.idre.ucla.edu
Then it will ask you for your password and you type in your password and you are now logged in. 
...
1. what is ~   --> This is the command that means your home
2. what is ../ --> This command means the previous directory.
3. what is ./? --> This command means the current directory your in.
...
````
$ cd . --> This command just keeps you in the current directory.
$ cd / --> This command moves you to a / directory
$ cd /home/amanda --> This command moves you to amanda's directory
$ cd ../..  --> This command brings you back two directories
$ cd ~  --> This command brings you back to the home directory
$ cd home  --> This just takes you to the home directory
$ cd ~/data/..   --> If you type in this command all together, then it will bring you back to your home (~) directory because the .. brings you back one directory and you were only one directory away from the home directory. 
...
1. Using the filesystem diagram below, if pwd displays `/Users/thing`, what will `ls -F ../backup` display?
  ...
  a. `../backup: No such file or directory`  (YES)
